...
RSpec.shared_context 'with consolidation tenants' do
  ...
  def seed_sponsor(site, level_name:, sponsor_name:, with_logo: false, logo_file: test_png, logo_name: File.basename(logo_file))
    within_tenant(site) do
      ...
      sponsor.logo = Rack::Test::UploadedFile.new(logo_file, 'image/png', original_filename: logo_name) if with_logo
